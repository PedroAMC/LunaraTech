    ...
    <main className="mx-auto max-w-5xl px-4 py-8 grid gap-6 md:grid-cols-2">
      <section className="card p-4">
        ...
        <p className="mt-3 text-sm text-white/70">
          *En producción integraríamos <b>Transbank</b>, <b>Mercado Pago</b> o{" "}
          <b>Stripe</b>.
        </p>
      </section>
      ...
      <aside className="card p-4">
        ...
        <div className="mt-4 flex justify-between text-sm">
          <Link href="/carrito" className="hover:underline text-white/80">
            Volver al carrito
          </Link>
          <button onClick={clear} className="hover:underline text-white/70">
            Vaciar
          </button>
        </div>
      </aside>
